...
function setup() {
 ...
 player.debug=true
 //player.setCollider("rectangle",25,25,)
 gameover= createSprite(300,300)
 gameover.addImage(gameoverImage)
 invisibleWall = createSprite(190,375,10,750)
 invisibleWall.visible = false
 invisibleWall2 = createSprite(410,375,10,750)
...
function draw() {
 ...
 if (gameState === PLAY){
        ...
        player.depth+=1
        invisibleWall.depth=bridge.depth
        ...
        player.scale=0.3
            ...
            if (player.isTouching(policeGroup)||player.isTouching(invisibleWall)||player.isTouching(invisibleWall2)){
